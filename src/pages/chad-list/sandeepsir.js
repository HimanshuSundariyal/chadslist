    ...
    <>
...

      {
        ...
        chadsList.map((item,i)=>(
         <>
         {
           i==0  || i==chadsList.length-1 &&
           <div className="col-md-6 col-xl-3 mb-4 d-xl-none d-block">
           <Title>FILTERS</Title>
           <BackgroundSelect className="mx-auto" label={'BACKGROUND'} />
           <BodySelect className="mx-auto" label={'BODY'} />
       ...
       <div key={i+'key'} data={i} className="col-md-6 col-xl-3 mb-4">
            <Card>
          ...
          {
             i==2 &&
             <div className="col-md-6 col-xl-3 mb-4 d-xl-block d-none">
             <Title>FILTERS</Title>
